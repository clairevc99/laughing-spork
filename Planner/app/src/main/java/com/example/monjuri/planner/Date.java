...
public class Date extends Fragment implements Edit_Add.OnFragmentInteractionListener {
    ...
    public void addButtons() {
        ...
        while (c.moveToNext()) {
            ...
            ev += c.getString(c.getColumnIndex("event_name")) + (!(c.getString(c.getColumnIndex("category")).equals("Holiday") || c.getString(c.getColumnIndex("category")).equals("School")) ? " at " + c.getString(c.getColumnIndex("hour")) + ": " + minute : "");
            eve.setText(ev);
